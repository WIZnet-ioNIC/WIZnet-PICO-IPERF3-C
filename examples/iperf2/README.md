...
2. Setup network configuration such as IP in 'wizchip_iperf.c' which is the iPerf example in 'WIZnet-PICO-C/examples/iperf2/' directory.
...
3. Setup iPerf configuration in 'wizchip_iperf.c' in 'WIZnet-PICO-C/examples/iperf2/' directory.
...
2. When the build is completed, 'wizchip_iperf.uf2' is generated in 'WIZnet-PICO-C/build/examples/iperf2/' directory.
...
2. Drag and drop 'wizchip_iperf.uf2' onto the USB mass storage device 'RPI-RP2' or 'RP2350'.
